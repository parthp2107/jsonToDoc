---
layout: default
title: dashboard-properties-name
permalink: /dashboard.md/dashboard-properties-name.md/
---
# Untitled string in Dashboard entity Schema

```txt
https://streaminlinedata.ai/entity/data/dashboard.json#/properties/name
```
